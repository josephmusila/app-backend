...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unit', models.ManyToManyField(to='base.customexams')),
            ],
        ),
        migrations.CreateModel(
            name='Timetable',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otherme', models.CharField(blank=True, max_length=50, null=True)),
                ('surname', models.CharField(blank=True, max_length=50, null=True)),
                ('idnumber', models.IntegerField(blank=True, null=True, unique=True)),
                ('dateOfBirth', models.DateField(blank=True, null=True)),
                ('password', models.IntegerField(blank=True, default=12345678, null=True)),
                ('email', models.EmailField(blank=True, max_length=254, null=True, unique=True)),
                ('residence', models.CharField(blank=True, max_length=50, null=True)),
                ('religion', models.CharField(blank=True, default='Christian', max_length=50, null=True)),
        ...
        migrations.AddField(
            model_name='customexams',
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='base.units'),
        ),
        migrations.CreateModel(
            name='CourseExams',
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='base.course')),
                ('units', models.ManyToManyField(to='base.unitmarks')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
